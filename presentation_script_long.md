...
Đề án cũng bật mô hình chuyển làn phụ cho xe máy để mô phỏng tốt hơn đặc trưng dòng xe hỗn hợp. Trong toàn mạng lưới, 41 bộ điều khiển đèn tín hiệu được đưa vào quá trình huấn luyện như các tác tử điều khiển.
...
Chỉ số cuối là số sự kiện dịch chuyển cưỡng bức. Trong đề án, đây là chỉ số hỗ trợ để theo dõi các tình huống tắc nghẽn nghiêm trọng trong mô phỏng. Chỉ số này còn chịu ảnh hưởng của hình học mạng đường, cấu hình mô phỏng và dao động giữa các hạt giống, nên không được dùng một mình để kết luận phương pháp nào tốt hơn.
